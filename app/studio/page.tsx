          ...
          <div className="max-w-prose">
            <section>
              ...
              <p className="mt-6 text-base leading-relaxed">
                Bay Area based creative director and photographer, specializing in editorial,
                commercial, and artist imagery. My work blends creativity with a keen eye for
                detail, focusing on everything from studio portraits to location shoots.
                Photography allows me to explore the world through a unique lens and I&rsquo;m
                dedicated to bringing out the beauty in every subject I work with. Whether
                it&rsquo;s a personal project or a collaboration, I strive to create images that
            ...
            <section className="mt-16">
              ...
              <p className="mt-6 text-base leading-relaxed">
                My vision is to create captivating visual stories that go beyond the surface. As
                one person behind the lens, I am dedicated to capturing the unique essence of each
                subject with authenticity, creativity, and a commitment to integrity, crafting
                images that resonate and inspire.
              </p>
            </section>

            <section className="mt-16">
              <h2 className="label text-muted-foreground">Selected clients &amp; press</h2>
              <ul className="mt-6 flex flex-col divide-y divide-border border-y border-border">
                {PRESS.map((p) => (
                  <li key={p.slug}>
                    ...
                    >
                      <span className="font-display text-xl uppercase tracking-[0.04em]">{p.name}</span>
                      <span
                        aria-hidden
